    ...
    S: Send + Sync + 'static,
{
    fn htlc_deployed(
        ...
        self.bitcoin_connector.htlc_deployed(htlc_params, after)
    }
    ...
    fn htlc_funded(
        ...
        self.bitcoin_connector
            .htlc_funded(htlc_params, htlc_deployment, after)
    }
    ...
    fn htlc_redeemed_or_refunded(
        ...
        self.bitcoin_connector.htlc_redeemed_or_refunded(
            htlc_params,
            htlc_deployment,
            htlc_funding,
            after,
    ...
    Web3Connector: HtlcEvents<Ethereum, A>,
{
    fn htlc_deployed(
        ...
        self.ethereum_connector.htlc_deployed(htlc_params, after)
    }
